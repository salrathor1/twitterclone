        ...
        const eachCard = this.state.cards.map((card, index) => {
            return (
                <div className="main1" key={index}>
                    <li className="trending"> {card.trending} </li>
                    <li className="hashtag"> {card.hashtag} </li>
                    ...
                    {card.innerCard.theme === "" ? (
                        ...
                        <div className="inside">
                            <div className="text">
                                <li className="inner-card1">
                                    {card.innerCard && card.innerCard.theme}{" "}
                                </li>
                                <li className="inner-card2">
                                    {card.innerCard && card.innerCard.desc}{" "}
                                </li>
                            </div>
                    ...
                    <li className="people1"> {card.people} </li>
                </div>
            );
        });
